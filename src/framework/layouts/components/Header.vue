...
import LogoFull from '@framework/assets/assets-logo-full.svg?component';
import LanguageSwitcher from '@framework/components/LanguageSwitcher.vue';
...
const menuTheme = computed(() => theme);
