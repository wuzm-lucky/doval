...
import SettingAutoIcon from '@framework/assets/assets-setting-auto.svg';
import SettingDarkIcon from '@framework/assets/assets-setting-dark.svg';
import SettingLightIcon from '@framework/assets/assets-setting-light.svg';
import ColorContainer from '@framework/components/color/index.vue';
import Thumbnail from '@framework/components/thumbnail/index.vue';
import { DEFAULT_COLOR_OPTIONS } from '@framework/config/color';
import STYLE_CONFIG from '@framework/config/style';
