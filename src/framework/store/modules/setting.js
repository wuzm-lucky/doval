...
import { DARK_CHART_COLORS, LIGHT_CHART_COLORS } from '@framework/config/color';
import STYLE_CONFIG from '@framework/config/style';
import { store } from '@framework/store';
import { generateColorMap, insertThemeStylesheet } from '@framework/utils/color';
...
export const useSettingStore = defineStore('setting', {
  ...
  getters: {
    ...
    displaySideMode: (state) => {
      return state.sideMode;
    },
  },
  actions: {
    async changeMode(mode = 'auto') {
      let theme = mode;
